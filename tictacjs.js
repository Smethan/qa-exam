...
var _rollbarConfig = {
    accessToken: "23532bca1f2740cf83247e6b7c389bd7",
...
function initializeBoard() {
    ...
    Rollbar.info('Initializing board')
...
function handleClick(evt) {
    ...
    if (cell) {
        ...
        Rollbar.error('User clicked something without actually clicking something?')
    }
}
...
function startGame(evt) {
    ...
    Rollbar.warning('All errors should come after this, Initializing game...')
    initializeBoard();
